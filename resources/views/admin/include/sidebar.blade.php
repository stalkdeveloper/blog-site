        ...
        <div class="navbar-content scroll-div " >
            ...
            <ul class="nav pcoded-inner-navbar ">
                ...
                <li class="nav-item pcoded-hasmenu">
                    <a href="{{route('getAllArticles')}}" class="nav-link "><span class="pcoded-micon"><i class="feather icon-layout"></i></span><span class="pcoded-mtext">Article Management</span></a>
                    <ul class="pcoded-submenu">
                        <li><a href="{{route('getAllArticles')}}" target="_blank">All Posts</a></li>
                ...
                <li class="nav-item pcoded-hasmenu">
                    ...
                    <ul class="pcoded-submenu">
                        <li><a href="layout-vertical.html" target="_blank">All Categories</a></li>
                        <li><a href="layout-horizontal.html" target="_blank">Horizontal</a></li>
                    </ul>
                </li>
                <li class="nav-item pcoded-menu-caption">
                ...
                <li class="nav-item pcoded-hasmenu">
                    ...
                    <ul class="pcoded-submenu">
                        <li><a href="bc_button.html">Roles</a></li>
                    </ul>
                </li>
            </ul>    
        </div>
