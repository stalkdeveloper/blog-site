<header class="navbar pcoded-header navbar-expand-lg navbar-light header-dark">
    ...
    <div class="m-header">
        <a class="mobile-menu" id="mobile-collapse" href="{{ url('/dashboard') }}"><span></span></a>
        <a href="{{ url('/dashboard') }}" class="b-brand">
            <!-- ========   change your logo hear   ============ -->
            {{-- <img src="assets/images/logo.png" alt="" class="logo"> --}}
            {{-- <img src="assets/images/logo-icon.png" alt="" class="logo-thumb"> --}}
           <h4 style="color:#fff; padding-right: 30px;">Blog Site</h4>
        </a>
                            ...
                            <li class="notification">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <p><strong>John Dev</strong><span class="n-time text-muted"><i class="icon feather icon-clock m-r-10"></i>5 min</span></p>
