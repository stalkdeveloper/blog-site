    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('getStoreCategory')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control ckeditor" id="description" name="description" placeholder="Enter Description" rows="2" required>{{old('description')}}    </textarea>
                                </div>
                            </div>
                            <div class="col-sm-3"></div>
                        </div>
